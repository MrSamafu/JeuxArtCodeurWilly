Shader "Ciconia Studio/Shader Painter/MetalRough/Wind VertexOffset (DirectX 11 Only)"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult5_g378 = lerp( float3(0,0,1) , UnpackNormal( tex2D( _BumpMap, ( uv_BumpMap * _TilingLayer1 ) ) ) , _NormalIntensity1);
			float3 Normalmap338 = lerpResult5_g378;
			...
			float4 temp_output_505_0 = ( _CiconiaStudiowindvertexoffset * lerp(( _Color * float4( desaturateVar16_g349 , 0.0 ) ),float4( lerpResult27_g349 , 0.0 ),_VisualizeWind) );
			...
			float4 tex2DNode3_g380 = tex2D( _MetallicGlossMap, ( uv_MetallicGlossMap * _TilingLayer1 ) );
			float4 temp_output_504_0 = ( _SpecularColor1 * tex2DNode3_g380 * _Metallic );
			float4 Metallic274 = temp_output_504_0;
			o.Metallic = Metallic274.r;
			float Roughness275 = ( tex2DNode3_g380.a * _Glossiness );
			o.Smoothness = Roughness275;
			float2 uv_OcclusionMap = i.uv_texcoord * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
			float blendOpSrc2_g381 = tex2D( _OcclusionMap, ( uv_OcclusionMap * _TilingLayer1 ) ).r;
			float blendOpDest2_g381 = ( 1.0 - _AoIntensity1 );
			float Aomap351 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g381 ) * ( 1.0 - blendOpDest2_g381 ) ) ));
